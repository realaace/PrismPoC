...
#End Region
    ...
    Public Sub New()
        ...
        Me.RowDefinitions.Add(New RowDefinition() With { _
            .Height = New GridLength(1, GridUnitType.Star) _
        })
        Me.RowDefinitions.Add(New RowDefinition() With { _
            .Height = New GridLength(0) _
        })
        Me.RowDefinitions.Add(New RowDefinition() With { _
            .Height = New GridLength(0) _
        })
        ...
        Dim title As New TextBlock() With { _
            .Visibility = Global.System.Windows.Visibility.Visible, _
            .TextWrapping = TextWrapping.NoWrap, _
            .TextTrimming = TextTrimming.CharacterEllipsis, _
            .FontWeight = FontWeights.Bold _
        }
        Dim descrip As New TextBlock() With { _
            .Visibility = Global.System.Windows.Visibility.Visible, _
            .TextWrapping = TextWrapping.Wrap, _
            .TextTrimming = TextTrimming.CharacterEllipsis _
        }
        Dim dock__1 As New DockPanel() With { _
            .Visibility = Global.System.Windows.Visibility.Visible, _
            .LastChildFill = True, _
        ...
        Me.HelpText = New Border() With { _
            .Visibility = Global.System.Windows.Visibility.Visible, _
            .BorderBrush = SystemColors.ActiveBorderBrush, _
            .Background = SystemColors.ControlBrush, _
            .BorderThickness = New Thickness(1), _
            .Child = dock__1 _
        }
        Me.Splitter = New GridSplitter() With { _
            .Visibility = Global.System.Windows.Visibility.Visible, _
            .ResizeDirection = GridResizeDirection.Rows, _
            .Height = 5, _
            .HorizontalAlignment = Global.System.Windows.HorizontalAlignment.Stretch _
        }
